...
darkModeToggle.addEventListener('click', () => {
    ...
    if (!isDarkMode) {
        body.style.backgroundColor = "#e96dd4";
...
const cuteImageWithStyle = {
    ...
    const docDefinition = {
        ...
        header: (currentPage, pageCount) => {
            return { text: 'Carrito de compras (Seccion de Mujeres)', fontSize: 24, margin: [0, 10, 0, 20], bold: true, alignment: 'center', color: '#ff007f' };
        },
